                        ...
                        <div class="checkout-form">
                            <form method="post" action="{{route('guest.checkout.order')}}" id="paymentForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="billing_name" name="billing_name" placeholder="{{__('You Name Here')}}" value="{{ isset($billing) ? $billing->Name : '' }}" required/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="billing_email" name="billing_email" placeholder="{{__('Email Address')}}" value="{{ isset($billing) ? $billing->Email : '' }}" required/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="billing_street_address" name="billing_street_address" placeholder="{{__('Street Address')}}" value="{{ isset($billing) ? $billing->Street : '' }}" required/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="shipping_name" name="shipping_name" placeholder="{{__('You Name Here')}}" value="{{ isset($shipping) ? $shipping->Name : '' }}" required/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="shipping_email" name="shipping_email" placeholder="{{__('Email Address')}}" value="{{ isset($shipping) ? $shipping->Email : '' }}" required/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            @foreach ($paymentPlatforms as $payment)
                                                ...
                                                @endif
                                                    @if ($payment->slug == 'paystack')
                                                        <div class="form-group">
                                                            <div class="form-check card-check">
                                                                <input class="form-check-input" type="radio" name="payment" id="paystack" value="paystack" />
                                                                <label class="form-check-label" for="paystack">{{$payment->name}}</label>
                                                                <div class="input-icon">
                                                                    <img src="{{asset(IMG_PAYMENT_GATEWAY.$payment->image)}}" alt="paystack" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="pay_to_razorpay" id="pay-to-razorpay" value="{{round(convertToINR(\Cart::subtotal() + allsetting()['shipping_charge'] + tax_amount(\Cart::subtotal()) - Session::get('CouponAmount')))}}">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="mt-3" >
                                                                            ...
                                                                            {{__('Name on Account:')}} {{env('BANK_ACCOUNT_HOLDER_NAME')}} <br>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
