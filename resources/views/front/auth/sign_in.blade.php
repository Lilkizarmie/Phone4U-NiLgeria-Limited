                    ...
                    <div class="login-wrap">
                        ...
                        <form class="login-form" method="post" action="{{route('user.sign.in.post')}}">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control rounded-left" placeholder="{{__('Email')}}" name="email" value="{{ app()->environment('local') ? '' : old('email') }}" required="">
                            </div>
                            <div class="form-group d-flex">
                                <input type="password" class="form-control rounded-left" placeholder="{{__('Password')}}" name="password" value="{{ app()->environment('local') ? '' : '' }}" required="">
                            </div>
                            <div class="form-group">
