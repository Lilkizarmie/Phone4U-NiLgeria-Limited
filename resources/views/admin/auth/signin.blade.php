                        ...
                        <form action="{{ route('login.post') }}" method="post">
                            ...
                            <div class="input__group mb-25">
                                ...
                                <div class="input-overlay">
                                    <input type="text" name="email" id="email" value="{{ app()->environment('local') ? '' : old('email') }}" placeholder="{{__('Enter email address')}}">
                                    <div class="overlay">
                            ...
                            <div class="input__group mb-20">
                                ...
                                <div class="input-overlay">
                                    <input type="password" name="password" id="pass" value="{{ app()->environment('local') ? '' : '' }}" placeholder="{{__('Enter password')}}">
                                    <div class="overlay">
